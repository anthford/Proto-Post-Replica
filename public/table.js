window.addEventListener('load', function() {
  ...
  var backLeftPx = 0.05*width.toString() + "px";
  ...
  var missionTopPx = 0.08*height.toString() + "px";
  var missionLeftPx = 0.27*width.toString() + "px";
  ...
  var letterTopPx = 0.15*height.toString() + "px";
  ...
  var rumorTopPx = 0.08*height.toString() + "px";
  var rumorLeftPx = 0.37*width.toString() + "px";
